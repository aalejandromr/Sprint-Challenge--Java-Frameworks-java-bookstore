package com.lambdaschool.sprintchallengeII.config;
...
public class DataSourceConfig {
    ...
    public DataSource dataSource() {
        ...
        {
            myUrlString = "jdbc:postgresql://" + System.getenv("DBHOST") + ":5432/" + System.getenv("DBNAME");
            myDriverClass = "org.postgresql.Driver";
            myDBUser = System.getenv("DBUSER");
            myDBPassword = System.getenv("DBPASSWORD");
        } else
        {
            // Assumes H2
